            ...
            <div className="hidden justify-between items-center w-full md:flex md:w-auto md:order-2" id="mobile-menu-3">
              ...
              <ul className="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
                  <li>
                    {
                        header=='Explorer' ?
                        <a href="/explorer" className="block py-2 pr-4 pl-3 text-lg roboto bg-black rounded-3xl text-white border-b border-gray-100 hover:bg-black md:hover:bg-black md:border-0 md:hover:text-blue-700 md:p-2 md:px-12 md:dark:hover:text-white dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-black dark:border-gray-700">EXPLORER</a>
                        :
                        <a href="/explorer" className="block py-2 pr-4 pl-3 text-lg roboto text-gray-700 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-2 md:px-12 md:dark:hover:text-white dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">EXPLORER</a>
                    }
                  </li>
                  <li>
